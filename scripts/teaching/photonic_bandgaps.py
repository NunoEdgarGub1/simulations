...
def DBR (N=5, th0 = 0., l0 = 900, n1=1.5, n2=2, do_plot = False):
	...
	if do_plot:
		...
		plt.plot (l_array, 1-R, linewidth=3, color='royalblue')
...
def DBR_defect (N=5, th0 = 0., l0 = 900, n1=1.5, n2=2, do_plot = False):
	...
	for ind,l in enumerate(l_array):
		...
		phi_cav = 2000/n1
		Gcav = np.matrix([[np.exp(1j*phi_cav), 0],[0, np.exp(-1j*phi_cav)]])		
