...
H[0,0] = 0.0;                 H[0,1] = Om/2.0*np.sqrt(2.0); H[0,2] = 0.0; H[0,3] = 0.0;
H[1,0] = Om/2.0*np.sqrt(2.0); H[1,1] = D;                   H[1,2] = 0.0; H[1,3] = Om/2.0*np.sqrt(2.0);
H[2,0] = 0.0;                 H[2,1] = 0.0;                 H[2,2] = 0.0; H[2,3] = 0.0;
H[3,0] = 0.0;                 H[3,1] = Om/2.0*np.sqrt(2.0); H[3,2] = 0.0; H[3,3] = 2.0*D;
