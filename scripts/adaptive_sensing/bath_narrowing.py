...
exp.set_msmnt_params (N=9, G=3, F=1, tau0=1e-6, fid0=1., fid1=0.)
...
exp.set_semiclassical (True)
exp.simulate_same_bath (funct_name = 'adaptive_1step', string_id = '', max_steps = 7, 
        do_plot=True, do_debug = True, do_save=False)
